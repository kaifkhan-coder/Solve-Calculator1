...
import { UploadIcon, CalculatorIcon, ErrorIcon, ResultIcon, EquationIcon } from './components/Icons';
        ...
        <main className={`rounded-xl shadow-lg p-6 sm:p-8 transition-colors duration-500 ${getBackgroundColor()}`}>
          {!imagePreview ? (
            <div className="flex flex-col items-center justify-center border-2 border-dashed border-slate-300 rounded-lg p-12 text-center">
              ...
              <h2 className="text-xl font-semibold text-slate-700">Upload an Image</h2>
              <p className="text-slate-500 mt-1">PNG, JPG, or WEBP files are welcome.</p>
              <label htmlFor="file-upload" className="mt-6 cursor-pointer inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-transform hover:scale-105">
                Select a File
              </label>
            ...
            <div className="space-y-6">
              ...
              {processState === 'processing' && (
                <div className="flex flex-col items-center justify-center text-center p-4">
                  <Spinner />
                  <p className="text-lg font-medium text-blue-700 mt-4">AI is calculating...</p>
